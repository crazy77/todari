...
export function GameCanvas() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(TopBar, { onOpenRanking: () => setRankingOpen(true) }), _jsxs("div", { ref: containerRef, className: "h-[100svh] w-full pt-14", children: [appState === 'auth' && (_jsx("div", { className: "grid h-full place-items-center p-5", children: _jsxs("div", { className: "w-full max-w-sm space-y-4 card p-6 text-center", children: [_jsx("div", { className: "font-extrabold text-2xl text-slate-800", children: "todari" }), _jsx(KakaoLoginButton, {}), _jsx("div", { className: "text-sm text-slate-500", children: "\uB610\uB294" }), _jsx(JoinOverlay, { roomId: '', onDone: () => setAppState('menu') })] }) })), appState === 'menu' && (_jsx("div", { className: "grid h-full place-items-center p-5", children: _jsxs("div", { className: "w-full max-w-sm space-y-4 card p-6", children: [_jsxs("div", { className: "flex items-center justify-between gap-3", children: [_jsx("button", { type: "button", className: cn('btn-ghost text-sm', mode === 'solo' ? 'ring-2 ring-brand-primary' : ''), onClick: () => {
                                                setMode('solo');
                                                setTotalRounds(3);
                                            }, children: "\uC194\uB85C" }), _jsx("button", { type: "button", className: cn('btn-ghost text-sm', mode === 'speed' ? 'ring-2 ring-brand-primary' : ''), onClick: () => {
                                                setMode('speed');
                                                setTotalRounds(3);
                                            }, children: "\uC2A4\uD53C\uB4DC\uBC30\uD2C0" })] }), mode === 'speed' && (_jsxs("div", { className: "text-center text-sm text-slate-600", children: ["\uCC38\uAC00\uC790: ", participants, "\uBA85"] })), _jsx("button", { type: "button", className: "w-full btn-primary", onClick: () => {
                                        setRound(1);
                                        setAppState('playing');
