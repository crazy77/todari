...
export function Scoreboard({ roomId }: { roomId: string }): JSX.Element {
  ...
  useEffect(() => {
    function onState({ state }: { state: any }) {
  ...
  return (
    <div style={{ position: 'fixed', top: 8, right: 8, background: 'rgba(0,0,0,0.5)', color: '#fff', borderRadius: 8, padding: 8, width: 160 }}>
