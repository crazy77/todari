...
export function MemoryGame({ onRoundClear, totalRounds, currentRound, score, onScoreChange, onRoundBreakdown, }) {
    ...
    return (_jsxs("div", { className: "mx-auto w-full max-w-sm select-none p-3", children: [_jsxs("div", { className: "mb-3 flex items-center justify-between text-slate-600 text-sm", children: [_jsxs("span", { className: "pill", children: ["Score: ", score] }), _jsxs("span", { className: "pill", children: ["Round: ", round, "/", totalRounds ?? settings.rounds] }), _jsxs("span", { className: "pill", children: [(elapsedMs / 1000).toFixed(1), "s"] })] }), _jsx("div", { className: cn('grid gap-3 sm:gap-4', 
                // 모바일 기본 3열, 넓은 폭에서 4열
                `grid-cols-${COLS} sm:grid-cols-4`), style: {
